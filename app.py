...
st.line_chart(data=leituras, x='Datetime', y='TempOut', color='#008000')
...
st.line_chart(data=leituras, x='Datetime', y='SolarRad', color='#8B4513')
...
st.line_chart(data=leituras, x='Datetime', y='HumOut', color='#000000')
